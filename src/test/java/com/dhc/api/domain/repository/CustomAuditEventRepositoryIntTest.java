package com.dhc.api.domain.repository;

import com.dhc.api.domain.AimsBillingGatewayApp;
import com.dhc.api.domain.config.Constants;
import com.dhc.api.domain.config.audit.AuditEventConverter;
import com.dhc.api.domain.domain.PersistentAuditEvent;
...
import static com.dhc.api.domain.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
